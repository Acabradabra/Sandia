...
Yco2=[0    ,0.111,0]
Yco =[0    ,4e-3 ,0]
M=[12,16,44,28,18,28] # C CH4 CO2 CO H2O N2
...
if MIX :
	...
	#===================================================================================
	def Yc(Ych4,Yco2,Yco) : return( M[0]*(Ych4/M[1]+Yco2/M[2]+Yco/M[3]) )
	#===================================================================================
	Yc_f=Yc(Ych4[0],Yco2[0],Yco[0])
	Yc_p=Yc(Ych4[1],Yco2[1],Yco[1])
	Yc_o=Yc(Ych4[2],Yco2[2],Yco[2])
